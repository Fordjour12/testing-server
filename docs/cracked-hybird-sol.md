...
```
User Request → Generate Plan → [Decision Point]
                                    ├─ Save Immediately → Direct Permanent Save
                                    ├─ Preview Mode → In-Memory + Optional Staging
                                    └─ Hybrid → Smart Auto-Decision Based on Context
```
